...
propertyChanged("_HasCollision", _HasCollision);
            if(_IsPlayingSound)
{
                sayToScene("Sound Manager PM", "_customBlock_StopSceneSound", ["Laser Loop SFX",getCurrentSceneName()]);
                _IsPlayingSound = false;
...
propertyChanged("_IsPlayingSound", _IsPlayingSound);
            sayToScene("Sound Manager PM", "_customBlock_LoopSceneSound", ["Laser Loop SFX",getCurrentSceneName()]);
}
