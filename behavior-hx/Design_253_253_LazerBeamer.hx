...
propertyChanged("_HasCollision", _HasCollision);
            if(_IsPlayingSound)
{
                sayToScene("Sound Manager PM", "_customBlock_StopSceneSoundForActor", ["Laser Loop SFX",getCurrentSceneName(),actor]);
                _IsPlayingSound = false;
propertyChanged("_IsPlayingSound", _IsPlayingSound);
        ...
        else if(!(_IsPlayingSound))
{
            _IsPlayingSound = true;
propertyChanged("_IsPlayingSound", _IsPlayingSound);
            sayToScene("Sound Manager PM", "_customBlock_StopSceneSoundForActor", ["Laser Loop SFX",getCurrentSceneName(),actor]);
            sayToScene("Sound Manager PM", "_customBlock_LoopSceneSoundForActor", ["Laser Loop SFX",getCurrentSceneName(),actor]);
}
