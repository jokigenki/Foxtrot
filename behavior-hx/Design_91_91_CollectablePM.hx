...
nameMap.set("Actor", "actor");
	...
	{
		            if((!(_AlwaysAllowCollection) && (!(actor.hasBehavior("Display On Collected PM")) && cast((scripts.Design_206_206_DoorsAndInventoryExtrasPM._customBlock_ItemHasBeenCollected(_CollectableId)), Bool))))
{
            recycleActor(actor);
}
