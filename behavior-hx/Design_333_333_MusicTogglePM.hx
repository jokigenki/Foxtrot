...
class Design_333_333_MusicTogglePM extends ActorScript
{          	
	    public function _customEvent_MusicToggle():Void
{
        ...
        else
{
    ...
    public function _customEvent_MusicOff():Void
{
        actor.setAnimation("" + "Inactive");
}

    public function _customEvent_MusicOn():Void
{
