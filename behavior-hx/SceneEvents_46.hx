...
return;
    ...
    addWhenKilledListener(getActor(302), function(list:Array<Dynamic>):Void {
if(wrapper.enabled){
        runLater(1000 * 0.5, function(timeTask:TimedTask):Void {
                    if(getGameAttribute("Game Complete"))
{
                        getActor(301).setValue("Teleport To Scene PM", "_DestinationSceneName", "Final Boss|Transition To Home All|A|A");
}
