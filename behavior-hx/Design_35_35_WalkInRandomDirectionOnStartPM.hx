...
class Design_35_35_WalkInRandomDirectionOnStartPM extends ActorScript
{          	
	...
	override public function init()
	{
                    ...
                    if((randomInt(Math.floor(0), Math.floor(1)) < 0.5))
{
                        /* "Custom: Set \"Left\" to <true> for Self, Set \"Right\" to <false> for Self" */
...
{
                        /* "Custom: Set \"Right\" to <true> for Self, Set \"Left\" to <false> for Self" */
