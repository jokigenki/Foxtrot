...
class Design_429_429_BigBossEggCollectablePM extends ActorScript
{          	
...
if(wrapper.enabled && sameAsAny(getActorGroup(0),event.otherActor.getType(),event.otherActor.getGroup())){
        if((!(("" + _CollectableId) == ("")) && (_AlwaysAllowCollection || !(cast((scripts.Design_206_206_DoorsAndInventoryExtrasPM._customBlock_ItemHasBeenCollected(_CollectableId)), Bool)))))
{
