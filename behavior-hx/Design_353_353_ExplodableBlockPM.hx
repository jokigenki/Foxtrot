...
class Design_353_353_ExplodableBlockPM extends ActorScript
{          	
        ...
        if(((eventActor == actor) || !(eventActor.hasBehavior("Explodable Block PM"))))
{
        ...
        if(((hasValue(_ImmuneToTypes) != false) && Utils.contains(_ImmuneToTypes, eventActor.getType())))
{
            return;
}
...
propertyChanged("_DistanceFromExplosion", _DistanceFromExplosion);
        _OtherExplodeRadius = asNumber(eventActor.getValue("Explodable Block PM", "_ExplodeRadius"));
