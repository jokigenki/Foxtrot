...
public var _MyRegion:Region;

 
 	public function new(dummy:Int, engine:Engine)
	{
		super(engine);
		nameMap.set("MyRegion", "_MyRegion");
                    ...
                    if((!(getGameAttribute("Save Destination") == "none") && !(("" + getGameAttribute("Save Destination")).split("|")[Std.int(1)] == "_Home")))
{
        ...
        createBoxRegion(422, 222, 45, 43);
        _MyRegion = getLastCreatedRegion();
propertyChanged("_MyRegion", _MyRegion);
    addActorEntersRegionListener(_MyRegion, function(a:Actor, list:Array<Dynamic>):Void  {
