            ...
            else
{
            ...
            g.drawString("" + "" + (sayToScene("Speed Run Timer PM", "_customBlock_ConvertNumberToTimeString", [(_LocalSpeedRunSuccessTime - _LocalSpeedRunTime)])), (_XPosition + ((getScreenWidth() - 640) / 2)), (_YPosition + ((getScreenHeight() - 384) / 2)));
}
