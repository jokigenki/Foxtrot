        ...
        else
{
            ...
            setGameAttribute("Rat Timer", ((getActor(39).getX() - cast((scripts.Design_27_27_ActorExtrasPM._customBlock_GetActorInScene(getGameAttribute("Last Rat"))), Actor).getX()) * 5));
...
_RatOffset = 0.0;
	...
	{
		            if((getGameAttribute("Last Destination") == "Factory2_07|Factory2_06|C|D"))
{
...
propertyChanged("_RatOffset", _RatOffset);
                if((_RatOffset > 384))
{
                    _RatOffset = asNumber(384);
propertyChanged("_RatOffset", _RatOffset);
}

                getActor(30).setX((getActor(30).getX() - _RatOffset));
                getActor(33).setX((getActor(33).getX() - _RatOffset));
}
            ...
            else if((getGameAttribute("Rat Timer") > 0))
{
                ...
                recycleActor(getActor(34));
                recycleActor(getActor(27));
                runLater(1000 * (getGameAttribute("Rat Timer") / 1000), function(timeTask:TimedTask):Void {
                            getActor(33).shout("_customEvent_" + "MakeSpawn");
                            getActor(30).shout("_customEvent_" + "MakeSpawn");
}, null);
}
        ...
        else
{
        ...
        if(!(getGameAttribute("Last Destination") == "Factory2_05|Factory2_06|B|A"))
{
            trace("" + "");
            recycleActor(getActor(41));
