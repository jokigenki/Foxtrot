...
class Design_153_153_ReloadOnDeathPM extends ActorScript
{          	
        ...
        if(getGameAttribute("Speed Run In Progress"))
{
        ...
        if(!(isTransitioning()))
{
            if(sceneHasBehavior("Reload Scene On Death PM"))
{
                sayToScene("Reload Scene On Death PM", "_customEvent_" + "Reload");
}
