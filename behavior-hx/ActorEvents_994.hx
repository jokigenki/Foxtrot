...
class ActorEvents_994 extends ActorScript
{          	
...
{
            if(cast((actor.say("ActorEvents_994", "_customBlock_TouchInside", [(event.stageX - Engine.screenOffsetX) / (Engine.screenScaleX * Engine.SCALE),(event.stageY - Engine.screenOffsetY) / (Engine.screenScaleY * Engine.SCALE)])), Bool))
{
